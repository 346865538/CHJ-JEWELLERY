...
var hrefs2 = ['http://vipcw33.top/teamobject/gdzd.html','http://vipcw33.top/teamobject/swrx.html','http://irm.p5w.net/ssgs/S002345/?code=002345'];
...
$('.ulsongta1').on('click',function(){
	window.location.href = "http://vipcw33.top/teamobject/mostlike.html";
})

$('.ulsongta2').on('click',function(){
	window.location.href = "http://vipcw33.top/teamobject/mostlike2.html";
})
...
$('.class1 li,.class2 li').on('click',function(){
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            { '&zIndex': 1, width: 80, height: 50, top: 71, left: 134, $opacity: 0.5 },
            { '&zIndex': 2, width: 160, height: 107, top: 61, left: 20, $opacity: 0.6 },
            { '&zIndex': 3, width: 248, height: 166, top: 37, left: 110, $opacity: 0.7 },
            { '&zIndex': 4, width: 384, height: 257, top: 0, left: 200, $opacity: 1 },
            { '&zIndex': 3, width: 248, height: 166, top: 37, left: 420, $opacity: 0.7 },
            { '&zIndex': 2, width: 160, height: 107, top: 61, left: 590, $opacity: 0.6 },
            { '&zIndex': 1, width: 80, height: 50, top: 71, left: 580, $opacity: 0.5 }
        ]
